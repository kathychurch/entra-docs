...
1. If you wish to configure the application in **SP** initiated mode, then perform the following step:
    ...
    > [!NOTE]
    > These values are not real. Update these values with the actual Identifier, Reply URL and Sign on URL. Contact [Tanium SSO support team](mailto:support@tanium.com) to get these values. You can also refer to the patterns shown in the **Basic SAML Configuration** section.
...
To configure single sign-on on **Tanium SSO** side, you need to send the **App Federation Metadata Url** to [Tanium SSO support team](mailto:support@tanium.com). They set this setting to have the SAML SSO connection set properly on both sides.
